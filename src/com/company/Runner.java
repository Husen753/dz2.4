...
public class Runner extends Thread{
    ...
    public synchronized void run() {
        ...
        if (getName().equals("Runner5")) {
            ...
            System.out.println(getName() + " идёт палку ");
            System.out.println(getName() + " идёт к финишу ");
            System.out.println("_________________________");
            try {
                sleep(500);
            } catch (Exception ignored) {
            }
            System.out.println(getName() + " идёт к " + runnerF.getName());
            try {
                sleep(500);
            } catch (Exception ignored) {
            }
            ...
            System.out.println(getName() + " идёт к " + runnerS.getName());
            try {
                sleep(500);
